...
import { Accordion, AccordionDetails, AccordionSummary, Box, Chip, FormControl, Input, Stack, Typography } from "@mui/material";
...
import { setCategories, setRangeDateFrom, setRangeDateTo, setTextFilter } from "@/store/slices/eventsFilterSlice";
