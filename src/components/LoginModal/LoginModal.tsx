...
export default function LoginModal() {
  ...
  const isPhoneFlow =
    !emailAuthEnabled || isPhoneIdentifier || phoneConfirmation !== null;
  const isLoading =
    status === "loading" ||
    phoneLoading ||
    (emailAuthEnabled && passwordResetLoading);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Typography variant="caption" mb={1} mt={2} color={"text"}>
